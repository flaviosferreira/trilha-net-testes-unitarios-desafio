...
public class ValidacoesStringTests
{
    ...
    public void DeveContemAPalavraQualquerNoTexto()
    {
        ...
        // Act
         var resultado = _validacoes.ContemCaractere(texto.ToLower(), textoProcurado.ToLower());
    ...
    public void TextoDeveTerminarComAPalavraProcurado()
    {
        ...
        // Act
        var resultado = _validacoes.TextoTerminaCom(texto.ToLower(), textoProcurado.ToLower());
